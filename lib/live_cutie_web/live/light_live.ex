  ...
  def render(assigns) do
    ...
    <div id="light" class="max-w-xl mx-auto text-center">
      <div class="flex h-12 overflow-hidden text-base bg-cool-gray-300 rounded-lg mb-8">
        <span class="flex flex-col justify-center text-cool-gray-900 text-center whitespace-nowrap bg-yellow-300 font-bold" style="width: <%= @brightness %>%; transition: width 2s ease;">
          <%= @brightness %>
        </span>
      </div>
      ...
      <button><img src="images/light-on.svg" alt="Lights On" class="w-10"></button>
    </div>
    """
  end
end
